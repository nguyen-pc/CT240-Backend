...
public class ResponseService {
    ...
    public ResponseService(ResponseRepository responseRepository, SurveyService surveyService, QuestionService questionService, ChoiceService choiceService, ProjectService projectService) {
...
//            check question
            ...
            Question question = this.questionService.getQuestion(projectId, surveyId, answer.getQuestion().getQuestionId());
            if (question == null)
            ...
            if (question.getQuestionType().isMultipleOrCheckbox()) {
                ...
                if (choiceList == null || choiceList.isEmpty()) {
                    ...
                    for (Choice choice : choiceList) {
                        ...
                        if (dbChoice == null)
                            throw new IllegalArgumentException("Could not find a choice with id: " + choice.getChoiceId());
                        if (question.getQuestionId() != dbChoice.getQuestion().getQuestionId())
                            throw new IllegalArgumentException("Question with id " + answer.getQuestion().getQuestionId() + " DOES NOT contain survey with id: " + dbChoice.getChoiceId());
                    }
                }
            } else {
